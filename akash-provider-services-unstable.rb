...
class AkashProviderServicesUnstable < Formula
  ...
  on_linux do
    if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
      url "https://github.com/ovrclk/akash/releases/download/v0.1.0-rc16/provider-services_linux_arm64.zip"
    ...
    if Hardware::CPU.intel?
      url "https://github.com/ovrclk/akash/releases/download/v0.1.0-rc16/provider-services_linux_amd64.zip"
